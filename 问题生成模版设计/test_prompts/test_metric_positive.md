...
```json
{
  "entity_a": {
    "name_zh": "河池市",
    "centroid": [107.8459, 24.6402],
    "type": "city"
  },
  "entity_b": {
    "name_zh": "衡水市",
    "centroid": [115.8285, 37.763],
    "type": "city"
  },
  "spatial_facts": {
    "distance_km": 1643
...
|--------|------|------|
| `河池市` | 实体A中文名称 | "北京市" |
| `[107.8459, 24.6402]` | 实体A质心坐标 [lng, lat] | [116.407, 39.904] |
| `city` | 实体A地理类型 | "city" |
| `衡水市` | 实体B中文名称 | "上海市" |
| `[115.8285, 37.763]` | 实体B质心坐标 [lng, lat] | [121.474, 31.230] |
| `city` | 实体B地理类型 | "city" |
| `1643` | A与B之间的直线距离（公里） | 1068 |
