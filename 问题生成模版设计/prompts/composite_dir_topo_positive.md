...
空间事实: {"direction_8": "{{fact_direction_8}}", "azimuth_deg": {{fact_azimuth_deg}}, "within": true}
难度: {{difficulty}}
```
...
```json
{
  "true_false": {"question": "<判断题题目文本>", "answer": "<自然语言答案>", "answer_structured": {"type": "boolean", "value": true, "direction": "<八方向>", "within": true, "explanation": "..."}, "difficulty": "{{difficulty}}"},
  "choice": {"question": "<选择题题目文本>", "options": {"A": "...", "B": "...", "C": "...", "D": "..."}, "answer": "<自然语言答案，说明正确选项>", "answer_structured": {"type": "option", "value": "<正确选项字母>", "direction": "<八方向>", "within": true, "explanation": "..."}, "difficulty": "{{difficulty}}"},
  "fill_blank": {"question": "<填空题题目文本，用____表示空白>", "answer": "<自然语言答案>", "answer_structured": {"type": "keyword", "value": "<填空答案>", "explanation": "..."}, "difficulty": "{{difficulty}}"},
  "open_qa": {"question": "<问答题题目文本>", "answer": "<自然语言答案，详细说明方向和拓扑关系>", "answer_structured": {"type": "free_text", "direction": "<八方向>", "within": true, "explanation": "..."}, "difficulty": "{{difficulty}}"}
}
```
