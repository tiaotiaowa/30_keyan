...
def main():
    parser = argparse.ArgumentParser(description="Exp9: GeoKD-SR(Full) 评估")
    ...
    if weights_path.exists():
        ...
        print(f"学习到的空间关系权重: {learned_weights}")
